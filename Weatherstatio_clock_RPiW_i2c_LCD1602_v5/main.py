...
# actual project by Nicu FLORICA (niq_ro): https://github.com/tehniq3/MicroPython_weatherstation_clock_RPiW_i2c_LCD1602/
...
wdt=WDT(timeout=8000)  #https://docs.micropython.org/en/latest/library/machine.WDT.html
...
openweather_api_key = "niq_rocanreceivesomebeers"
